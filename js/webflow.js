...
! function(t) {
	...
	r.resize = b(c, "resize.webflow orientationchange.webflow load.webflow"), r.scroll = b(c, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), r.redraw = b(), r.location = function(t) {
		window.location = t
	...
	function m(t, e, n) {
		return e.length ? function t(e, n, r, i) {
			var o = n[i];
			return y(e, o, i === n.length - 1 ? r : t(f(e) && f(e[o]) ? e[o] : "number" == typeof n[i + 1] ? [] : {}, n, r, i + 1))
		}(t, e, n, 0) : n
	}
		...
		var D = e.frame = function() {
			...
			k = f((function(t) {
				...
				t.init = function(t, e, n, r) {
					...
					var i = e[0];
					n[2] && (i = n[2]), K[i] && (i = K[i]), this.name = i, this.type = n[1], this.duration = c(e[1], this.duration, 500), this.ease = function(t, e, n) {
			...
			U = f((function(e) {
				...
				e.init = function(t) {
					...
					this.active || (this.start || (this.start = M()), this.active = !0, this, 1 === c.push(this) && D(n))
				}, e.stop = function() {
					var e, n;
	...
	t.exports = function(t, e, i, o) {
		...
		function f(e) {
			...
			return f >= .001 ? function(t, e, n, r) {
				...
				return e
			}(e, s, t, i) : 0 === f ? s : function(t, e, n, r, i) {
				var o, a, c = 0;
				do {
		...
		return function(n) {
			return t === e && i === o ? n : 0 === n ? 0 : 1 === n ? 1 : u(f(n), e, o)
		}
	}
}, function(t, e, n) {
	"use strict";
				...
				i ? function(t) {
					...
					if ((0, f.default)(d)) {
						(0, v.default)(d, (function(t, e) {
							...
							(z(p, u.mediaQueryKeys) || n.dispatch((0, g.mediaQueriesDefined)()), a.actionTypeId === E.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION) && (Array.isArray(o.config) ? o.config : [o.config]).forEach((function(e) {
						...
						var p = function(t) {
								...
								lt(d, (function(r, o, c) {
									...
									if (B(p, e.mediaQueryKey)) {
										...
										if (l.actionTypeId === E.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION)(Array.isArray(s.config) ? s.config : [s.config]).forEach(v);
										else v()
									}
								}))
							},
	...
	function at(t) {
		...
		e.active && (e.eventListeners.forEach(ut), t.dispatch((0, g.sessionStopped)()))
	}
	...
	function vt(t) {
		...
		(0, v.default)(n, (function(t) {
			if (!t.continuous) {
				var n = t.actionListId,
					r = t.verbose;
				gt(t, e), r && e.dispatch((0, g.actionListPlaybackChanged)({
					actionListId: n,
					isPlaying: !1
				}))
			}
	...
	function ht(t) {
		...
		(0, v.default)(u, (function(t) {
			...
			if (t.actionListId === o && t.eventId === n && a) {
				...
				gt(t, e), t.verbose && e.dispatch((0, g.actionListPlaybackChanged)({
					actionListId: o,
					isPlaying: !1
				}))
			}
	...
	function _t(t) {
		...
		r.dispatch((0, g.instanceAdded)((0, a.default)({
			...
			skipMotion: S,
			skipToValue: n
		}, o))), yt(document.body, "ix2-animation-started", _), f ? function(t, e) {
			var n = t.getState().ixParameters;
			t.dispatch((0, g.instanceStarted)(e, 0)), t.dispatch((0, g.animationFrameChanged)(performance.now(), n)), mt(t.getState().ixInstances[e], t)
		}(r, _) : (P({
			store: r,
			select: function(t) {
	...
	t.exports = function(t, e, n, h, E, _) {
		...
		if (O && !T) return _ || (_ = new r), g || f(t) ? i(t, e, n, h, E, _) : o(t, e, m, n, h, E, _);
		if (!(1 & n)) {
			var w = T && v.call(t, "__wrapped__"),
				A = b && v.call(e, "__wrapped__");
			if (w || A) {
				var S = w ? t.value() : t,
					R = A ? e.value() : e;
				return _ || (_ = new r), E(S, R, n, h, _)
			}
		}
		return !!O && (_ || (_ = new r), a(t, e, n, h, E, _))
	}
}, function(t, e, n) {
	var r = n(50),
		i = n(227),
	...
	Object.defineProperty(e, "__esModule", {
		value: !0
	}), e.createElementState = m, e.mergeActionState = I, e.ixElements = void 0;
	var r = n(22),
		i = n(3),
		...
		switch (e.type) {
			...
			case _:
				var n = e.payload,
					...
					s = u.actionTypeId,
					f = t;
				return (0, r.getIn)(f, [i, o]) !== o && (f = m(f, o, c, i, u)), I(f, i, s, a, u);
			case g:
				var l = e.payload;
	...
	Object.defineProperty(e, "__esModule", {
		...
		switch (r.actionTypeId) {
			...
			case at:
				var a = i(t, P),
					u = i(t, D);
				return {
					widthValue: r.config.widthUnit === W ? It.test(a) ? parseFloat(a) : parseFloat(n.width) : (0, f.default)(parseFloat(a), parseFloat(n.width)), heightValue: r.config.heightUnit === W ? It.test(u) ? parseFloat(u) : parseFloat(n.height) : (0, f.default)(parseFloat(u), parseFloat(n.height))
				};
			case ut:
			case ct:
			case st:
		...
		switch (n.actionTypeId) {
			...
			case nt:
				var i = n.config;
				return {
					xValue: i.xValue, yValue: i.yValue, zValue: i.zValue
				};
			case at:
				var o = r.getStyle,
					a = r.setStyle,
				...
				if (s === W) {
					var v = o(e, P);
					a(e, P, ""), d = u(e, "offsetWidth"), a(e, P, v)
				}
				if (f === W) {
					var h = o(e, D);
					a(e, D, ""), p = u(e, "offsetHeight"), a(e, D, h)
				}
				return {
		...
		switch (u) {
			case K:
				return function(t, e, n, r, i) {
					var o, a, u, c, s, f = Ct.map((function(t) {
							var n = St[t],
								r = e[t] || {},
								i = r.xValue,
						...
						l = i.setStyle;
					Dt(t, g.TRANSFORM_PREFIXED, i), l(t, g.TRANSFORM_PREFIXED, f), o = n, a = r.actionTypeId, u = o.xValue, c = o.yValue, s = o.zValue, (a === J && void 0 !== s || a === tt && void 0 !== s || a === et && (void 0 !== u || void 0 !== c)) && l(t, g.TRANSFORM_STYLE_PREFIXED, R)
				}(t, e, n, i, a);
			case q:
	...
	function mt(t) {
		...
		var N, x, C, L = (null !== (e = null == o || null === (n = o.action) || void 0 === n || null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[T || O] || {},
	...
	function Ft(t) {
		...
		e.actionItems.forEach((function(t) {
			var e, i = t.actionTypeId,
				o = t.config;
			e = (0, _.isPluginType)(i) ? (0, _.clearPlugin)(i) : kt({
				effect: Gt,
				actionTypeId: i,
				elementApi: r
			}), mt({
		...
		function T() {
			...
			if (c = arguments, s = this, p = t, n) {
				if (void 0 === d) return function(t) {
					return v = t, d = setTimeout(m, e), h ? g(t) : l
				}(p);
				if (E) return clearTimeout(d), d = setTimeout(m, e), g(p)
			}
			return void 0 === d && (d = setTimeout(m, e)), l
		}
		return e = o(e) || 0, r(n) && (h = !!n.leading, f = (E = "maxWait" in n) ? a(o(n.maxWait) || 0, e) : f, _ = "trailing" in n ? !!n.trailing : _), T.cancel = function() {
	...
	r.define("scroll", t.exports = function(t) {
		var e = "click.wf-empty-link",
			...
			f = r.env("editor") ? ".w-editor-body" : "body",
			l = "header, " + f + " > .header, " + f + " > .w-nav:not([data-no-scroll])",
			d = 'a[href="#"]',
		...
		function _(e) {
			...
			if (!(r.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(n.className))) {
				var u, f = (u = n, v.test(u.hash) && u.host + u.pathname === i.host + i.pathname ? n.hash : "");
				if ("" !== f) {
					var d = t(f);
		...
		return {
			ready: function() {
				var t = e,
					r = n;
				u.on(r, 'a[href*="#"]:not(.w-tab-link):not(a[href="#"])', _), u.on(t, d, (function(t) {
					t.preventDefault()
	...
	i.define("forms", t.exports = function(t, e) {
		...
		s.ready = s.design = s.preview = function() {
			o = t("html").attr("data-wf-site"), u = "https://webflow.com/api/v1/form/" + o, d && u.indexOf("https://webflow.com") >= 0 && (u = u.replace("https://webflow.com", "https://formdata.webflow.com")), c = "".concat(u, "/signFile"), (n = t(p + " form")).length && n.each(m), _ || a || function() {
	...
	events: {
		e: {
			...
			target: {
				selector: ".your-link-block",
				originalId: "63732a147a96d6cc9d2a0841|0485a28f-7c26-1a7c-f2d3-1eb40417c67b",
				appliesTo: "CLASS"
			},
			targets: [{
				selector: ".your-link-block",
		...
		"e-2": {
			...
			createdOn: 1641144747637
		}
	},
	actionLists: {
		a: {
			id: "a",
			title: "Your Link Block HOVER IN",
			actionItemGroups: [{
				actionItems: [{
					id: "a-n",
					...
					config: {
						...
						target: {
							...
							selector: ".arrow-lottie-wrapper",
							selectorGuids: ["70e745b7-8096-77a4-4e8e-165b3b9a9809"]
						},
						value: "block"
					}
				}]
			...
			createdOn: 1641144750641
		},
		"a-2": {
			id: "a-2",
			title: "Your Link Block HOVER OUT",
			actionItemGroups: [{
				actionItems: [{
					id: "a-2-n",
					actionTypeId: "GENERAL_DISPLAY",
